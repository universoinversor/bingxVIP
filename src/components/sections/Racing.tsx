    ...
    <section ref={ref} className="py-24 relative overflow-hidden bg-[#030712] selection:bg-rose-600 selection:text-white">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="relative group overflow-hidden rounded-[24px] lg:rounded-[32px] border border-white/10 glass-effect">
            <div className="relative h-[400px] lg:h-[600px]">
              ...
              />
              <div className="absolute bottom-6 lg:bottom-10 left-6 lg:left-10 p-4 lg:p-6 glass-effect rounded-xl lg:rounded-2xl border-rose-600/30">
                 <div className="text-rose-500 text-[8px] lg:text-[10px] font-black uppercase tracking-widest mb-1 italic">Official Partner</div>
                 <div className="text-white text-xl lg:text-2xl font-black italic tracking-tighter uppercase font-heading">Scuderia Ferrari</div>
              </div>
            </div>
          </div>

          <motion.div style={{ y: textY }} className="space-y-6 lg:space-y-10">
            <div className="flex items-center gap-4 lg:gap-6 mb-8 lg:mb-10">
               <div className="w-12 h-12 lg:w-16 lg:h-16 rounded-xl lg:rounded-2xl bg-rose-600 flex items-center justify-center p-2 lg:p-3 shadow-[0_0_20px_rgba(225,29,72,0.4)]">
                  <Image src="/assets/img/ferrari_driver.png" alt="Ferrari Logo" width={60} height={60} className="object-contain brightness-0 invert" />
               </div>
               <div className="text-white text-xl lg:text-3xl font-black italic tracking-tighter uppercase font-heading">/// Scuderia <span className="text-rose-600">Ferrari</span> ///</div>
            </div>

            <h2 className="text-[44px] lg:text-8xl font-black italic tracking-tighter uppercase leading-[0.9] lg:leading-[0.8] text-white">
              Velocidad y <br />
              <span className="text-rose-600 drop-shadow-[0_0_30px_rgba(225,29,72,0.3)]">Precisión</span>
            </h2>

            <p className="text-slate-500 text-base lg:text-xl max-w-xl leading-relaxed font-bold italic border-l-4 border-rose-600 pl-4 lg:pl-6">
