...
export const Founder = () => {
  return (
    <section id="founder" className="py-40 relative bg-black">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
          ...
          >
             ...
             <div className="relative group overflow-hidden rounded-[40px] border border-white/10 aspect-[4/5] bg-white/5">
                <Image 
                ...
                {/* Minimalist Legend */}
                <div className="absolute bottom-8 left-8 right-8 glass-effect p-6 rounded-3xl border-white/10">
                   <div className="text-secondary text-[11px] font-bold uppercase tracking-widest mb-1">FOUNDER & CEO</div>
                   <div className="text-white font-bold text-2xl tracking-tight">Edwin Muñoz</div>
                </div>
             </div>
          </motion.div>
          ...
          >
             ...
             <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-white leading-[1.1] font-heading text-balance">
